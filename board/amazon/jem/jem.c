...
u32 get_board_rev(void)
{
	...
	// gpio_request(JEM_GPIO_MBID0, "MBID0");
	// gpio_request(JEM_GPIO_MBID1, "MBID1");
	// gpio_request(JEM_GPIO_MBID2, "MBID2");
	// gpio_request(JEM_GPIO_MBID3, "MBID3");

	// gpio_direction_input(JEM_GPIO_MBID0);
	// gpio_direction_input(JEM_GPIO_MBID1);
	// gpio_direction_input(JEM_GPIO_MBID2);
	// gpio_direction_input(JEM_GPIO_MBID3);

	// value |= (gpio_get_value(JEM_GPIO_MBID0) << 0);
	// value |= (gpio_get_value(JEM_GPIO_MBID1) << 1);
	// value |= (gpio_get_value(JEM_GPIO_MBID2) << 2);
	// value |= (gpio_get_value(JEM_GPIO_MBID3) << 3);

	// value = idme_get_board_id();

	// value = 8020400000000010u;
	value = 80204010u;
